      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            <li>
              <Link href="/signin" className="flex font-medium w-full text-gray-500 hover:text-white py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Iniciar sesión</Link>
            </li>
            <li>
              <Link href="/signup" className="btn-sm text-gray-200 bg-violet-600 hover:bg-violet-800 w-full my-2" onClick={() => setMobileNavOpen(false)}>
